...
if (build_pop_h) {
  ...
  for (ii in seq_len(nrow(pop_rows))) {
    ...
    asset <- list(
      ...
      beta_target = beta_target,
      n_analysis = direction_fits[[1]]$n_analysis,
      h_analysis = direction_fits[[1]]$h_analysis,
      sigma0_pop = direction_fits[[1]]$sigma0_pop,
      Sigma0_population = direction_fits[[1]]$Sigma0_population,
      n_population = n_population,
